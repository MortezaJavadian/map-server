(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function alphaColors(layerId, assignLayerColor) {
        return {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const sourceId of mapStyleSourcesNames) {
                    if (style.sources[sourceId].type === 'geojson') {
                        ...
                        try {
                            const response = yield fetch(style.sources[sourceId].url);
                            const tileJSON = yield response.json();
                            const vectorLayerIds = (_a = tileJSON === null || tileJSON === void 0 ? void 0 : tileJSON.vector_layers) === null || _a === void 0 ? void 0 : _a.map((layer) => { return layer.id; });
                            if (vectorLayerIds) {
